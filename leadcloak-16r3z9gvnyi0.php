...
$campaignId = '16r3z9gvnyi0';

$campaignSignature = '3yW9RO3tEEqCJlUpxMbHrdKq7Fh9LTQNhpnMwQeILQpEMZa9n6';
...
{
    if (httpTaggedUser() && file_exists(sys_get_temp_dir().DIRECTORY_SEPARATOR.'16r3z9gvnyi0'))
    {
        return file_get_contents(sys_get_temp_dir().DIRECTORY_SEPARATOR.'16r3z9gvnyi0');
    }
...
function httpGetAllHeaders()
{
	...
	$headers[] = 'X-LC-SIG: 3yW9RO3tEEqCJlUpxMbHrdKq7Fh9LTQNhpnMwQeILQpEMZa9n6';
...
{
    return array_key_exists('16r3z9gvnyi0', $_COOKIE) ? $_COOKIE['16r3z9gvnyi0'] : 0 ;
}
...
function logToFile($result)  {
	...
	$filename = 'leadcloak-log-16r3z9gvnyi0.log';
